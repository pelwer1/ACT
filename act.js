...
Add Custom Token to turn order

!act <change: default +1> <initial value: default 0> --<what to call it>
examples:
!act -1 10 --Count down from ten
!act +3 --Count up from 0 by threes
!act --counter starts at 0 and goes up by 1
!act -1 [[3d8]] --Something that lasts 3d8 rounds
!act -[[1d2]] 10 --something that might go twice as fast...
